...
torchrun --standalone --nproc_per_node=2 -m scripts.base_train -- --depth=6 --target-param-data-ratio=8 --window-pattern L --num-iterations=3000 --device-batch-size=16 --run=$WANDB_RUN
